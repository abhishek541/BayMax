...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        destination = bundle.getString("DestinationName");
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected List<List<HashMap<String, String>>> doInBackground(String... jsonData) {
            ...
            try {
                ...
                currentDistance = parser.parseDistance(jObject);
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                //Adding point to All points Array list
                ...
                if(lastDistance != 0.0) {
                    Log.d("Distance", "Last Distance:" + lastDistance.toString());
                }

                Log.d("Distance","Current Distance:"+currentDistance.toString());

                if(currentDistance > lastDistance && lastDistance!=0.0){
